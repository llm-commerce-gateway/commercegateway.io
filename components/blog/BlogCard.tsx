...
export function BlogCard({
  ...
  return (
    <article className="overflow-hidden rounded-lg border bg-background shadow-sm transition-shadow hover:shadow-md">
      ...
      <div className="p-5">
        ...
        <h2 className="font-semibold text-xl">
          <Link href={`/blog/${slug.current}`} className="hover:text-emerald-700 hover:underline">
            {title}
          </Link>
        </h2>
        <p
          className="mt-3 overflow-hidden text-muted-foreground text-sm"
          style={{
            display: "-webkit-box",
            WebkitLineClamp: 2,
