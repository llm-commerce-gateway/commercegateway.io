...
```ts
import { GeminiAdapter } from "@commercegateway/commerce-gateway/adapters";
...
To discover gateway endpoints for brands or GTINs before invoking tools, see [Registry overview](/docs/registry/overview) and [.well-known File](/docs/registry/well-known).
