...
For brand and product resolution to gateway endpoints, see the [Registry overview](/docs/registry/overview) and [.well-known File](/docs/registry/well-known) (`createRegistryClient` in `@commercegateway/commerce-gateway`).
