...
For brand and product resolution to gateway endpoints, see the [Registry overview](/docs/registry/overview) and [Discovery & Resolution](/docs/registry/discovery) (`createRegistryClient` in `@betterdata/commerce-gateway`).
